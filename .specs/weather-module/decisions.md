...
- Do not correct stale saved zones at weather-widget display time; concentrate zone accuracy in setup detection/selection and display saved setup values as-is.
